...
sections:
  - block: html
    ...
    content:
      text: |-
        <style>
          .vn-wrap{max-width:980px;margin:0 auto;padding:48px 20px 24px}
          ...
          .vn-role{font-size:22px;margin:12px 0 14px;color:#9a9a9a;font-style:italic}
          .vn-line{height:1px;background:#d9d9d9;margin:18px 0 14px}
          .vn-tags{font-size:14px;color:#9b9b9b;margin:0}
          .vn-bio{font-size:15px;color:#7d7d7d;line-height:1.65;margin:14px 0 0;max-width:640px}
          .vn-contact{margin-top:34px}
          .vn-contact-title{font-size:18px;color:#9a9a9a;letter-spacing:.8px;font-weight:600;margin:0 0 12px}
          .vn-icons{display:flex;gap:22px;align-items:center;justify-content:center;flex-wrap:wrap;margin:18px 0}
